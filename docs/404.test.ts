...
/**
 * @fileoverview Automated accessibility tests for the 404 page.
 *
 * Loads the actual docs/404.html body so that structural regressions — a
 * missing landmark, a skipped heading level, a missing alt attribute — fail
 * this test automatically. Colour contrast rules are disabled because jsdom
 * does not compute CSS cascade or paint.
 */
...
/**
 * Reads docs/404.html and returns the content of its body element.
 *
